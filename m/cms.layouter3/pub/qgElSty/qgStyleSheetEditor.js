...
qgStyleSheetEditor.prototype = {
	...
	show: function(ss) {
		...
		$.each(ss.cssRules, function(i,cssRule) {
			var unPseudoSel = cssRule.selectorText.replace(/:focus|:hover|:visited/,'');
		...
		/* move rules */
		var startPos = null;
		table.sortable({update:function(e,ui) {
