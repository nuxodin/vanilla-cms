...
'use strict';
{
	...
	ghost.style.cssText = 'background:#f05; outline:#ff5 3px solid; min-height:2px; max-height:10px; box-shadow:0 0 30px 3px rgba(0,0,0,.8); min-width:20px; z-index:999; position:relative; overflow:hidden; opacity:.9';
